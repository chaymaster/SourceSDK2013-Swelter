...
void ActivityList_RegisterSharedActivities(void)
{
	...
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_LASTROUND); // for firing the last round in revolver drum, no cocking after shot
	REGISTER_SHARED_ACTIVITY(ACT_VM_IRONSHOOT); // fire in ironsights
