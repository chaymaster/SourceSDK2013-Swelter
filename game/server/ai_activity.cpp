...
void CAI_BaseNPC::InitDefaultActivitySR(void)
{
	...
	ADD_ACTIVITY_TO_SR(ACT_VM_PRIMARYATTACK_LASTROUND); // for firing the last round in revolver drum, no cocking after shot
	ADD_ACTIVITY_TO_SR(ACT_VM_IRONSHOOT); // fire in ironsights
