...
#define SF_DRONE_PACKED_UP			(1 << 16)
#define SF_DRONE_NO_DAMAGE_EFFECTS	(1 << 17)
#define SF_DRONE_USE_AIR_NODES		(1 << 18)
#define SF_DRONE_CARRIED				(1 << 19)	// Being carried by a metrocop
#define SF_DRONE_NO_DANGER_SOUNDS		(1 << 20)

enum
{
	DRONE_EYE_STATE_IDLE,
	DRONE_EYE_STATE_CHASE,
	DRONE_EYE_STATE_CHARGE,
	DRONE_EYE_STATE_STUNNED,
};

//-----------------------------------------------------------------------------
// Attachment points.
//-----------------------------------------------------------------------------
#define	DRONE_GIB_HEALTH				30
#define	DRONE_INACTIVE_HEALTH			25
#define	DRONE_MAX_SPEED					1700 //было 500
#define DRONE_BURST_SPEED				1650
#define DRONE_NPC_BURST_SPEED			800

//-----------------------------------------------------------------------------
// Movement parameters.
//-----------------------------------------------------------------------------
#define DRONE_WAYPOINT_DISTANCE		25	// Distance from waypoint that counts as arrival.
...
// Drone 
//-----------------------------------------------------------------------------
class CNPC_Drone : public CNPCBaseInteractive<CAI_BasePhysicsFlyingBot>, public CDefaultPlayerPickupVPhysics
{
DECLARE_CLASS( CNPC_Drone, CNPCBaseInteractive<CAI_BasePhysicsFlyingBot> );
DECLARE_SERVERCLASS();
